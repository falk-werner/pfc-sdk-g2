...
FWUPDATE_SRC_DIR        := $(call ptx/in-path, PTXDIST_PATH, wago_intern/$(FWUPDATE))
...
WAGO_FWUPDATE_SRC_DIR        := $(call ptx/in-path, PTXDIST_PATH, shared_public/$(FWUPDATE))
...
$(STATEDIR)/fwupdate.targetinstall:
	...
	$(call install_copy, fwupdate, 0, 0, 0755, -, /usr/sbin/fwupdate_log)

...
SNMP_CONFIG_LIB_SRC_DIR        := $(call ptx/in-path, PTXDIST_PATH, local_src/$(SNMP_CONFIG_LIB))
...
PTXDIST_PACKAGE_MK_FILE=$(call ptx/in-path, PTXDIST_PATH, rules/snmp-config-lib.make)

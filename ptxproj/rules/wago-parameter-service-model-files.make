...
# Paths and names
#
WAGO_PARAMETER_SERVICE_MODEL_FILES_VERSION        := 0.11.0
...
WAGO_PARAMETER_SERVICE_MODEL_FILES_SRC_DIR        := $(PTXDIST_WORKSPACE)/wago_intern/$(WAGO_PARAMETER_SERVICE_MODEL_FILES_BASE)
...
WAGO_PARAMETER_SERVICE_MODEL_FILES_TARGET_DIR     := /etc/paramd
WAGO_PARAMETER_SERVICE_MODEL_FILES_INCLUDE_DIR    := /usr/include
WAGO_PARAMETER_SERVICE_MODEL_FILES_WDM_TARGET_DIR := $(WAGO_PARAMETER_SERVICE_MODEL_FILES_TARGET_DIR)/wdm
WAGO_PARAMETER_SERVICE_MODEL_FILES_WDD_TARGET_DIR := $(WAGO_PARAMETER_SERVICE_MODEL_FILES_TARGET_DIR)/wdd
...
# WDx artifacts 
WAGO_PARAMETER_SERVICE_MODEL_FILES_WDX_VERSION        := 0.0.11
...
# "normal" mode: install model files into target directories
	@mkdir -p $(WAGO_PARAMETER_SERVICE_MODEL_FILES_PKGDIR)/$(WAGO_PARAMETER_SERVICE_MODEL_FILES_TARGET_DIR) && \
	  cp -r $(WAGO_PARAMETER_SERVICE_MODEL_FILES_BUILDROOT_DIR)/wdm $(WAGO_PARAMETER_SERVICE_MODEL_FILES_PKGDIR)$(WAGO_PARAMETER_SERVICE_MODEL_FILES_TARGET_DIR)/ && \
	  cp -r $(WAGO_PARAMETER_SERVICE_MODEL_FILES_BUILDROOT_DIR)/wdd $(WAGO_PARAMETER_SERVICE_MODEL_FILES_PKGDIR)$(WAGO_PARAMETER_SERVICE_MODEL_FILES_TARGET_DIR)/ && \
	  chmod 644 $(WAGO_PARAMETER_SERVICE_MODEL_FILES_PKGDIR)$(WAGO_PARAMETER_SERVICE_MODEL_FILES_TARGET_DIR)/**/*.wdm.json && \
	  chmod 644 $(WAGO_PARAMETER_SERVICE_MODEL_FILES_PKGDIR)$(WAGO_PARAMETER_SERVICE_MODEL_FILES_TARGET_DIR)/**/*.wdd.json
...
$(STATEDIR)/wago-parameter-service-model-files.targetinstall:
	...
	@$(call install_copy, wago-parameter-service-model-files, 0, 0, 0750, $(WAGO_PARAMETER_SERVICE_MODEL_FILES_WDM_TARGET_DIR))
	@$(call install_glob, wago-parameter-service-model-files, 0, 0, -, $(WAGO_PARAMETER_SERVICE_MODEL_FILES_WDM_TARGET_DIR), *.wdm.json)

	@$(call install_copy, wago-parameter-service-model-files, 0, 0, 0750, $(WAGO_PARAMETER_SERVICE_MODEL_FILES_WDD_TARGET_DIR))
	@$(call install_glob, wago-parameter-service-model-files, 0, 0, -, $(WAGO_PARAMETER_SERVICE_MODEL_FILES_WDD_TARGET_DIR), *.wdd.json)
...
$(STATEDIR)/wago-parameter-service-model-files.clean:
	@$(call targetinfo)
	rm -rf $(PTXCONF_SYSROOT_TARGET)$(WAGO_PARAMETER_SERVICE_MODEL_FILES_TARGET_DIR)

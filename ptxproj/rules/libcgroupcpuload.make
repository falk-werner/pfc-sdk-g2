...
LIBCGROUPCPULOAD_SRC_DIR        := $(call ptx/in-path, PTXDIST_PATH, local_src/$(LIBCGROUPCPULOAD))
...
PTXDIST_PACKAGE_MK_FILE=$(call ptx/in-path, PTXDIST_PATH, rules/libcgroupcpuload.make)
